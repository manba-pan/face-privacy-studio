...
for name in ['av','mediapipe','opencv-contrib-python','numpy','pillow','imageio-ffmpeg','matplotlib','sounddevice','cffi','flatbuffers','absl-py','certifi','python-dateutil','six','contourpy','cycler','fonttools','kiwisolver','pyparsing','packaging','PySide6','PySide6_Essentials','PySide6_Addons','shiboken6','onnxruntime-directml','protobuf','sympy','mpmath']:
