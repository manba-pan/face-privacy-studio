...
def main():
    ...
    shutil.copytree(BASE/'docs',RELEASE/'docs',dirs_exist_ok=True)
    shutil.copytree(BASE/'assets'/'support',RELEASE/'assets'/'support',dirs_exist_ok=True)
    portable=BASE/'releases'/f'视频一键打码工具_{VERSION}_Windows_x64_便携版.zip'
    ...
    for folder in ['models','assets','docs','THIRD_PARTY','.github']:
    ...
    source=BASE/'releases'/f'视频一键打码工具_{VERSION}_源码整理包.zip'
